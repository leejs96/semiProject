                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">관리자님! 오늘도 좋은하루 되세요.</div>
                                            </div>
                                            <div class="col-auto">
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
                                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        	<a href="admin_product2.jsp">상품등록</a>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                    ...
                                    <div class="card-body" style="height: 200px;">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="mem.do">회원관리</a></div>
                                            </div>
                                            <div class="col-auto">
